...
export const configToml = {
    ...
    mongoDB: {
        connectionUri: `mongodb://${ContainersConfig.mongo.app.username}:${ContainersConfig.mongo.app.password}@localhost:${ContainersConfig.mongo.port}/${ContainersConfig.mongo.app.db}`,
    },
    nats: {
    ...
    clickHouse: {
        connectionUri: `clickhouse://${ContainersConfig.clickHouse.app.username}:${ContainersConfig.clickHouse.app.password}@localhost:${ContainersConfig.clickHouse.ports.tcp.port}/${ContainersConfig.mongo.app.db}`,
    },
    apps: {
        'cc-buyer-bot': {
            name: 'cc-buyer-bot',
